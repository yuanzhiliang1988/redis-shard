...
public class ApolloChangeListener {
    ...
    public ApolloChangeListener(ShardBeanFactory shardBeanFactory, Sharding sharding){
    ...
    public void initListener(){
        ...
        log.info("ApolloChangeListener init success handler size:{}",handlers.size());
    }
    ...
    private void configChangeListener(ConfigChangeEvent changeEvent) {
      ...
      /*  newNodesMap.forEach((k,v)->{
            log.info("newNodesMap:{},{},{},{},{},{},{}",k,v.getIndex(),v.getChangeType(),v.getAddresses(),v.isGray(),v.isDoubleWriter(),v.isTransfer());
        });*/
    ...
    private void buildChangeNodes(String nodeIndexStr,String changedKey,String newValue,Map<Integer,ShardNode> newNodesMap,Map<Integer, ShardNode> oldNodeMap,PropertyChangeType changeType){
        ...
        newNodesMap.compute(nodeIndex,(k,v)->{
            ...
            try {
                Field field = v.getClass().getDeclaredField(configFieldKey);
                field.setAccessible(true);
                field.set(v,changeType.equals(PropertyChangeType.DELETED)?(field.getType().equals(Boolean.class)?false:null):field.getType().equals(Boolean.class)?Boolean.parseBoolean(newValue):newValue);
