...
public class Jackson2JsonRedisSerializer<T> implements RedisSerializer<T> {
	...
	public static void main(String[] args) {
		...
		try {
			Object t1 = objectMapper.readValue(json, new TypeReference<Object>() {
			});
			String t = objectMapper.readValue(json, String.class);
			Object object = JSON.parseObject(JSON.toJSONString(t),Object.class);
			System.out.println("t:"+(Transfer)object);
