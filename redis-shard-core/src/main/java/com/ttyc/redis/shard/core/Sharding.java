...
//        });
    ...
    public ShardNode getShardNode(byte[] key) {
        ...
        log.info("nodeName:{},nextNodeName:{}",shardNode.getName(),shardNode.getNext()==null?null:shardNode.getNext().getName());
        return shardNode;
    }

    public ShardNode getShardNode(String key) {
        ShardNode shardNode = this.getShard(key);
        log.info("key:{},nodeName:{},nextNodeName:{}",key,shardNode.getName(),shardNode.getNext()==null?null:shardNode.getNext().getName());
